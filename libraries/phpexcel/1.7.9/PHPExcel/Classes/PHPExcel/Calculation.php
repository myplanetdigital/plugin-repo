...
class PHPExcel_Calculation {
	 ...
	 * @var boolean
	 */
	private static $_calculationCacheEnabled = false;
	...
	public function calculateCellValue(PHPExcel_Cell $pCell = null, $resetLog = true) {
		...
		try {
      $t = $this->_calculateFormulaValue($pCell->getValue(), $pCell->getCoordinate(), $pCell);

			$result = self::_unwrapResult($t);
		} catch (Exception $e) {
			throw(new Exception($e->getMessage()));
		}
    ...
    //echo '$pCellParent : ' . $pCellParent;
    //echo ' wsTitle : ' . $wsTitle . '<br>;
